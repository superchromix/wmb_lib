...
;     
;     loc_id:            Identifier of the file or group to create the 
;                        table within.
;                        
;     table_name:        The name of the dataset to create.
;     
;     record_definition: A structure variable which defines the field names
;                        and data types of each record.
;                        
...
;
;     databuffer:        Data to be written to the table.
;
;     Note that this table creation function does not support fill values.
;
;
