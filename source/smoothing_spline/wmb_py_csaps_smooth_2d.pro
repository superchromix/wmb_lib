...
;
;   wmb_py_csaps_smooth_2d
;   
;   CSAPS cubic smoothing spline
;
;cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc

function wmb_py_csaps_smooth_2d, xgrid_coords, $
                                 ygrid_coords, $
                                 z_data, $
                                 weights_x = weights_x, $
                                 weights_y = weights_y, $
    ...
    function_name='wmb_py_csaps_smooth_2d_portable'
    ...
    output_smoothed_data = dblarr(grid_ydim,grid_xdim)
    ...
    output_smoothed_data = transpose(output_smoothed_data)

    if auto_smooth eq 1 then smoothing_factor = input_smoothing_factor

    return, output_smoothed_data

end



pro wmb_py_csaps_smooth_2d_test
    ...
    zsmooth = wmb_py_csaps_smooth_2d(xgrid_coords, $
                                     ygrid_coords, $
                                     z, $
                                     auto_smooth = 0, $
